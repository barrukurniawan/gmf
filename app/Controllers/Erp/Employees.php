...
class Employees extends BaseController {
	...
	public function delete_staff() {
		...
		if($this->request->getPost('type')=='delete_record') {
			...
			// Cascade delete training record data
			...
			$TrainingRecordHeaderModel->where('user_id', $id)->delete();
			$EmployeeEducationModel->where('user_id', $id)->delete();
			$EmployeeTrainingHistoryModel->where('user_id', $id)->delete();
			$EmployeeLicenseModel->where('user_id', $id)->delete();
			$EmployeeBasicCertificateModel->where('user_id', $id)->delete();
			// Delete user
