	...
	function staff_profile_photo($user_id){
		...
		if($user_info['user_type'] != 'customer'){
			if($user_info['profile_photo'] == '' || $user_info['profile_photo'] == 'no'){
				...
				if(file_exists('public/uploads/users/thumb/'.$user_info['profile_photo'])) {
					$user_img = base_url().'/public/uploads/users/thumb/'.$user_info['profile_photo'];
				} else {
					$user_img = base_url().'/public/uploads/users/'.$user_info['profile_photo'];
				}
			}
		} else {
			if($user_info['profile_photo'] == '' || $user_info['profile_photo'] == 'no'){
				...
				if(file_exists('public/uploads/clients/thumb/'.$user_info['profile_photo'])) {
					$user_img = base_url().'/public/uploads/clients/thumb/'.$user_info['profile_photo'];
				} else {
					$user_img = base_url().'/public/uploads/clients/'.$user_info['profile_photo'];
				}
			}
		}
		return $user_img;
