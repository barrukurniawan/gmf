...
//1: Staff Roles
$routes->get('erp/set-roles/', 'Roles::index', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/roles/add_role/', 'Roles::add_role', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/roles/update_role/', 'Roles::update_role', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/roles/delete_role/', 'Roles::delete_role', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
//2: Assets
$routes->get('erp/assets-list/', 'Assets::index', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/asset-view/(:segment)', 'Assets::asset_view', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/assets/assets_list/', 'Assets::assets_list', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/assets/read_asset/', 'Assets::read_asset', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/assets/add_asset/', 'Assets::add_asset', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/assets/update_asset/', 'Assets::update_asset', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/assets/delete_asset/', 'Assets::delete_asset', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);


// module types
$routes->get('erp/assets-category/', 'Types::asset_category', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/assets-brand/', 'Types::asset_brand', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
...
// employee training record (CV Training)
$routes->get('erp/training-record/', 'TrainingRecord::index', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/training-record-form/(:segment)', 'TrainingRecord::form', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/training-record-save/', 'TrainingRecord::save', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/training-record-print/(:segment)', 'TrainingRecord::print_cv', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/training-record-my/(:segment)', 'TrainingRecord::my_record', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/training-record-save-signature', 'TrainingRecord::save_employee_signature', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['get', 'post'], 'erp/training-record-sign/', 'TrainingRecord::sign_record', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/training-record-approvals/', 'TrainingRecord::approvals', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->match(['post'], 'erp/training-record-email/', 'TrainingRecord::send_email_reminder', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
// trainers
...
$routes->post('erp/capability-evaluation/delete_evaluation', 'CapabilityEvaluation::delete_evaluation', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
// Regulation Portal
