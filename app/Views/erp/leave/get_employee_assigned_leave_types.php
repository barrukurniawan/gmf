...
$leave_categories_str = $employee_detail ? $employee_detail['leave_categories'] : '';
if(empty($leave_categories_str)) {
    $leave_categories = array('all');
} else {
    $leave_categories = explode(',',$leave_categories_str);
}
$emp_cat = array('all');
?>
