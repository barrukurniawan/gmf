...
<body>
    ...
    <div class="page">
        <table class="main-table">
            ...
            <?php if($header['capability_no']): ?>
            <tr>
                <td style="padding: 4px;">
                    <strong>Capability No:</strong> <?= $header['capability_no'] ?> &nbsp;&nbsp;|&nbsp;&nbsp;
                    <strong>Date:</strong> <?= $header['evaluation_date'] ?> &nbsp;&nbsp;|&nbsp;&nbsp;
                    <strong>Item:</strong> <?= $header['type_of_aircraft'] ?>
                </td>
            </tr>
            <?php endif; ?>
            <tr>
