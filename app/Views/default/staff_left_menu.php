...
<ul class="pc-navbar">
  ...
  <?php } ?>
  <?php
  $TrainingRecordHeaderModelApproval = new \App\Models\TrainingRecordHeaderModel();
  $has_approval_records = $TrainingRecordHeaderModelApproval
    ->groupStart()
      ->where('prepared_by_id', $usession['sup_user_id'])
